...
from src.video_probe.coros import load_videos, probe_video, run_video_probes
...
@celery_app.task(name="load_videos_task")
def load_videos_task() -> None:
    run_async(load_videos())
